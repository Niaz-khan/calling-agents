...
from conversations.call_intelligence import (
    build_transcript,
...
class TestGenerateCallSummary:
    def test_generates_summary(self, tenant, monkeypatch):
        ...
        monkeypatch.setattr(
            "conversations.call_intelligence.generate_response",
...
class TestClassifyCallOutcome:
    ...
    def test_appointment_booked_from_database(self, tenant, monkeypatch):
        ...
        monkeypatch.setattr(
            "conversations.call_intelligence.generate_response", self._no_llm()
        )
    ...
    def test_returns_unknown_when_llm_fails(self, tenant, monkeypatch):
        ...
        monkeypatch.setattr(
            "conversations.call_intelligence.generate_response", _boom
        )
