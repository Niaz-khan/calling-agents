...
from apps.appointments.services import check_availability, create_appointment
...
from apps.knowledge.services import search_knowledge_base as knowledge_search
