...
def generate_public_identifier() -> str:
    ...
    Never derived from internal database ids, so a web widget exposes zero
    internal identity. 128 bits of entropy (22 url-safe characters).
    """
...
class AgentDeployment(models.Model):
    ...
    # Allowed origins for web widgets. Empty list = no cross-origin enforcement.
